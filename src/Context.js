...
const ProfileContext = React.createContext();
 ...
 class ProfileProvider extends Component {
    ...
    updateValue=(e,test)=>{
        ...
        if(test==="mobile"){
            this.state.mobie = e.target.value;
        }
    ...
    onSave=(id)=>{
        if(!id ==""){
            ...
            Record["address"] = this.state.updateEdit[4];
            Record["mobie"] = this.state.updateEdit[5];
            this.setState({
        ...
        newArr['address'] = this.state.updateEdit[4];
        newArr['mobile'] = this.state.updateEdit[5];
